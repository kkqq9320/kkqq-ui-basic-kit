...
const PUBLIC_TYPES = ["AppShellProps", "AutoGrowTextareaProps", "ButtonProps", "ButtonSize", "ButtonVariant", "Combo", "Conflict", "DateWheelPickerProps", "DialogProps", "DurationWheelPickerProps", "GridJustify", "HourFormat", "MobilePageTabRegistration", "MobileQuickBarItem", "ParsedShortcutBindings", "ParsedThemeColors", "ScrollSnapshot", "SectionTabsProps", "SegmentedControlProps", "SegmentedOption", "SelectOption", "SelectProps", "ShortcutAction", "ShortcutBackup", "ShortcutBindings", "ShortcutProviderProps", "ShortcutRegistry", "ShortcutSettingsProps", "ShortcutStorage", "SidebarFooter", "SidebarLabels", "SidebarNavItem", "SidebarNavSection", "SidebarProps", "SidebarToggleActionOptions", "ThemeColorBackup", "ThemeColorEditorProps", "ThemeName", "ThemePalette", "ThemeToken", "ThemeTokenGroup", "TimeWheelPickerProps", "VirtualKeyboard", "VisualViewportBox", "WheelLabels", "WheelPickerProps", "WheelRowsPerSide", "WheelUnit"];
