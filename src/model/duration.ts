 ...
 *
 * 이 파일은 **아무것도 import 하지 않습니다**(타입 제외). DOM도 React도
 * 설정 모듈도 모릅니다 — 기계가 구독해서 인자로 내려보냅니다(설계 스펙 §3.2).
 *
 * ⚠️ `instant/`의 조각들은 **서로를 import 합니다**(2026-08-19에 갈라졌습니다) — 그쪽과
 * 같은 것은 "DOM·React·설정 모듈을 모른다"까지이고, "아무것도 import 안 한다"는 여기만입니다.
 *
 * ## 기간은 시점과 무엇이 다른가
 *
